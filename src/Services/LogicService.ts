      ...
      const goods = [
        {
          ...
          price: 420,
          photoLink: "/moroz_app/assets/png/golland.png",
          slider: [],
          valueFields: [],
          typeFields: [],
          fields: {},
        ...
        },
        {
          ...
          title: "Сыр Чеддер",
          price: 580,
          photoLink: "/moroz_app/assets/png/chedder.png",
          slider: [],
          valueFields: [],
          typeFields: [],
          fields: {},
      ...
      const goods = [
        {
          ...
          title: "Сметана 20%",
          price: 210,
          photoLink: "/moroz_app/assets/png/20proc.png",
          slider: [],
          valueFields: [],
          typeFields: [],
          fields: {},
        ...
        },
        {
          ...
          title: "Сметана 15%",
          price: 240,
          photoLink: "/moroz_app/assets/png/15proc.png",
          slider: [],
          valueFields: [],
          typeFields: [],
          fields: {},
